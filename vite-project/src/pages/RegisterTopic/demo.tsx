    ...
    <div style={{ display: "flex", gap: 16, flexWrap: "wrap" }}>
      ...
      >
        <Paragraph>
          ...
          <ul>
            <li>
              <span>
                Sinh viên điền đầy đủ thông tin vào đơn đăng kí đề tài khóa luận
                tốt nghiệp.
              </span>
            </li>
            <li>
        ...
        >
          <Button type="primary" onClick={handleOpenModal1}>
      ...
      >
        ...
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          <Button type="primary" onClick={handleOpenModal2}>
      ...
      >
        <Paragraph>
          ...
          <ul>
            ...
            <li>
              <span>
                Khi gửi đơn sinh viên phải chịu trách nghiệm đến khoa làm việc,
                không thì đơn sẽ bị thu hồi.
              </span>
            </li>
            {/* <li></li> */}
          </ul>
